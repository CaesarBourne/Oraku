...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voices = MediaPlayer.create(MainActivity.this,R.raw.opelesongtest);
        voices.start();
    }
    ...
    public void startOpele(View view){
        Intent intent = new Intent(MainActivity.this, Test3DRotateActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigation_home) {
            ...
            Intent intent = new Intent(MainActivity.this, TestOpele.class);
            startActivity(intent);
        }
